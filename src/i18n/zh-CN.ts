...
export const zhCN: TranslationSchema = {
  ...
  prompts: {
    defaultSystem:
      "你是一个 Reasonix，一个得力的 DeepSeek 驱动的助手。请保持简洁准确。在可用时使用工具。\n\n# 引用或闭嘴 — 不可协商\n\n关于代码库的每个事实主张都必须有证据支持...",
    formattingRules: "格式化（在具有真实 markdown 渲染器的 TUI 中渲染）：...",
    escalationContract: "成本意识升级（当你运行在 deepseek-v4-flash 上时）：...",
    negativeClaimRule: '否定主张（"X 缺失"、"Y 未实现"、"没有 Z"）是排名第一的幻觉形式...',
    commitSystem: "你是一位专家级软件工程师，正在起草一条简洁、高信号的 git 提交消息...",
  },
  loop: {
